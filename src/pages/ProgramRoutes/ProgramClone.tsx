              ...
              <table className="table table-sm table-borderless align-middle description-table">
                <tbody>
                  <tr>
                    ...
                    <td>
                      <b>Notes</b> <p> {programmData.note}</p>
                    </td>
                    <td>
                                  ...
                                  <div className="d-flex">
                                    ...
                                    >
                                      <Form.Control
                                        ...
                                        defaultValue={
                                          cloneLocation.state.origin_point
                                            .placeName
                                        }
                                        required
                                      />
                                    ...
                                    <Flatpickr
                                      ...
                                      defaultValue={
                                        cloneLocation.state.pickUp_Time
                                      }
                                    />
                                  </div>
                                  ...
                                  <div className="d-flex">
                                    ...
                                    >
                                      <Form.Control
                                        ...
                                        defaultValue={
                                          cloneLocation.state.destination_point
                                            .placeName
                                        }
                                        required
                                      />
                                    ...
                                    <Flatpickr
                                      ...
                                      defaultValue={
                                        cloneLocation.state.dropOff_time
                                      }
                                    />
                                  </div>
                                </InputGroup>
                                        ...
                                        <div className="mb-3 d-flex">
                                          ...
                                          </Autocomplete>
                                          {
                                            <Flatpickr
                                              ...
                                              defaultValue={
                                                cloneLocation.state.stops.time
                                              }
                                            />
                                          }
                                        </div>
